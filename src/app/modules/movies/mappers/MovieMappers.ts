import { MovieDto, MoviesListResponseDataDto } from "../data/movies/MoviesResponse";
...
export function mapMoviesListDtoToDomain(dataDto: MoviesListResponseDataDto): MoviesList {
    return {
